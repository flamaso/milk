...
const MainMenu = ({ setSelectedMenu, setSearchResults }) => {
...
const SearchResultsTable = ({ rowData }) => {
    const columnDefs = useMemo(() => [
        { headerName: 'Verkauft am', field: 'datum', sortable: true, filter: true },
        { headerName: 'Titel', field: 'titel', sortable: true, filter: true },
        { headerName: 'Zustand', field: 'zustand', sortable: true, filter: true },
        { headerName: 'Preis', field: 'preis', sortable: true, filter: true },
        { headerName: 'eBay Nr', field: 'ebay_nr', sortable: true, filter: true },
    ], []);
    const defaultColDef = useMemo(() => ({
        flex: 1,
        minWidth: 100,
    ...
    return (
        <ConfigProvider>
            <Layout style={{ minHeight: '100vh', backgroundColor: 'black' }}>
                <MainMenu setSelectedMenu={setSelectedMenu} setSearchResults={setSearchResults} />
                ...
                <Content style={{
                    ...
                    {selectedMenu === '3' && searchResults.length === 0 && <DataTable rowData={rowData} updateRowData={updateItem} />}
                    {selectedMenu === '3' && searchResults.length > 0 && <SearchResultsTable rowData={searchResults} updateRowData={updateItem} />}
